...
<script type="text/x-template" id="root-dirs-template">
    <div id="root-dirs-wrapper">
        ...
        ## @TODO: remove this (use Vue $emit events / jQuery $events)
        <input type="text" style="display: none;" id="rootDirText" :value="rootDirsText" />
    </div>
</script>
<script>
Vue.component('root-dirs', {
    ...
    mounted() {
        ...
        this.$emit('update:root-dirs-text', this.rootDirsText);
